...
in_dswd="/fh/fast/huang_y/AMP_PK_Corr_noWin_test/nonmem/estimated_pk_concentration/"
out_dswd="/fh/fast/huang_y/AMP_PK_Corr_new/data/imperf_daily_grid_appr23_1recordpercase_appr3/"

ds1="m_2800_p1_0_p2_0_r1_0_r2_0_b30_0_b10_0_r3_0.04_ratio_2"
ds2="m_2800_p1_0_p2_0_r1_0_r2_0_b30_0.01_b10_0.012_r3_0.04_ratio_2"
ds3="m_2800_p1_0_p2_0_r1_0_r2_0_b30_0.02_b10_0.025_r3_0.04_ratio_2"
ds4="m_2800_p1_0_p2_0_r1_0_r2_0_b30_0.025_b10_0.03_r3_0.04_ratio_2"
ds5="m_2800_p1_0_p2_0_r1_0_r2_0_b30_0.03_b10_0.038_r3_0.04_ratio_2"

dsn="m_2800_p1_0_p2_0_r1_0_r2_0_b30_0.03_b10_0.038_r3_0.04_ratio_1"
dsn=c(ds1, ds2, ds3, ds4, ds5)
#-----------------------------------------------------------
...
prep_approach3 <- function(dat, case_input){
  ...
  dat0_final$status=0
  dat0_final$group=0
  dat0_final=dat0_final[,c("ID", "group", "TIME", "status", "IPRE","t_IPRE")]
...
#   dat0_final=dat0_final[,c("ID", "group", "TIME", "status", "IPRE")]
  ...
  data_out=data_out[,c("ID", "group", "TIME", "status", "IPRE", "tstart", "tstop","t_IPRE")]
  return(data_out)
...
coxmodel <- function(dat2, alpha=0.025){
  ...
  fit=coxph(Surv(tstart, tstop, status)~t_IPRE+cluster(ID), weights=w, data=dat2)
...
approach3 <- function(dat, alpha=0.025){
  ...
  cbind(n_cases_total, n_cases_appr, alpha, pe, dat_est_out, dat_true_out)
}  
...
result_list <- lapply(dsn,function(i){
  ...
  res <- data.frame(group=i
                    ...
                    ,power_est=mean(dsresults$higher_tail_test_est))
  
}

  )
result <- do.call(rbind,result_list)
write.csv(result,"/fh/fast/huang_y/AMP_PK_Sim_new/result.csv")
